...
private ArrayList<ThuChi> ContacList;
  ...
  //  private ConnectionReceiver receiver;
    ...
    public boolean onContextItemSelected(@NonNull MenuItem item) {
        switch (item.getItemId()){
            ...
            case R.id.idxoa:
               ...
               String message = "Bạn có muốn xóa? ";
              if (ContacList.get(selectedid).isPhuchi()) {
                message += "\nNgày tháng: " + ContacList.get(selectedid).getNgaythang() +
                      "\nTiền đến từ: " + ContacList.get(selectedid).getTennguoi()+
                      "\nSố tiền: " + ContacList.get(selectedid).getSotien();
                   } else {
               message += "\nNgày tháng: " + ContacList.get(selectedid).getNgaythang() +
                        "\nTiền đi tới: " + ContacList.get(selectedid).getTennguoi() +
                       "\nSố tiền: " + ContacList.get(selectedid).getSotien();
             }
    ...
    private void resetData(){
        db = new Phuong_Sql_ThuChi(MainActivity.this, "ContacttDB22",null,1);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        db = new Phuong_Sql_ThuChi(this, "ContacttDB22",null,1);
